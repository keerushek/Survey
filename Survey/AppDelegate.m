...
//Set UIWindow root view controller on app start
- (void)setRootViewController
{
    NSArray *userAccountArray = [User getAllUserAccounts];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.RescueApp.RescueApp" in the application's documents directory.
